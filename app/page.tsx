        ...
        <section className="hero" data-screen-label="Hero">
          ...
          <div className="wrap hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-appstore-row reveal" data-d="3">
          ...
          <div className="wrap">
            ...
            <div className="steps-grid">
              ...
              <article className="step-card accent-emerald reveal" data-d="3">
                ...
                <h3>Borrow $25–$100</h3>
                <p>Pick your amount and repayment plan. Funds land in 1–3 days for free — or instantly for a small fee. Pay on time, unlock more.</p>
                <span className="step-pill"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2 3 14h7l-1 8 11-13h-7z"/></svg>Instant or 1–3 days</span>
              </article>
            </div>
          </div>
        </section>
